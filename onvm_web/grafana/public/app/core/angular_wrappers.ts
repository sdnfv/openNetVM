...
export function registerAngularDirectives() {
  ...
  react2AngularDirective("functionEditor", FunctionEditor, [
    "func",
    "onRemove",
    "onMoveLeft",
    "onMoveRight"
  ...
  react2AngularDirective(
    ...
    SeriesColorPickerPopoverWithTheme,
    ["color", "series", "onColorChange", "onToggleAxis"]
  );
  ...
  react2AngularDirective(
    ...
    CloudWatchAnnotationQueryEditor,
    ["query", "onChange", ["datasource", { watchDepth: "reference" }]]
  );
  ...
  react2AngularDirective(
    ...
    LokiAnnotationsQueryEditor,
    ["expr", "onChange", ["datasource", { watchDepth: "reference" }]]
  );
